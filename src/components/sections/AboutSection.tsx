      ...
      <div className="space-y-6 flex-1 w-full lg:max-w-2xl">
          ...
          <div className="space-y-6 text-gray-800">
            <div>
              ...
              <p className="text-lg leading-relaxed">
                midnightLaundry is the creative universe of{' '}
                <a
                  href="https://linktree.com/briiitelord"
                  target="_blank"
                ...
                , and the many partnerships and collaborations to follow.
              </p>
            </div>
        ...
        <div className="flex justify-center">
          <iframe
            ...
            src="https://bandcamp.com/EmbeddedPlayer/album=1034874295/size=large/bgcol=ffffff/linkcol=0687f5/tracklist=false/transparent=true/"
            seamless
            title="Bandcamp Player"
          >
            <a href="https://briiitelord.bandcamp.com/album/the-best-ive-got-so-far-2">
              The Best I've Got So Far by BriiiteLord
            </a>
          </iframe>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-gradient-to-br from-emerald-50 to-emerald-100/50 rounded-lg border border-emerald-200 p-6">
            ...
            <p className="text-sm text-emerald-800">
              Explore diverse sounds and creative expressions
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-purple-50 to-purple-100/50 rounded-lg border border-purple-200 p-6">
            ...
            <p className="text-sm text-purple-800">
              Discover poetry, stories, and creative prose
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-blue-100/50 rounded-lg border border-blue-200 p-6">
            ...
            <p className="text-sm text-blue-800">
              Connect in a safe digital creative space
            </p>
          </div>
        </div>
      </div>
